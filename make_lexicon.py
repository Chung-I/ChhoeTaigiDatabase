from tsm.util import generate_tsm_lexicon, generate_initials, generate_finals
...
generate_tsm._lexicon(args.lexicon_path, args.grapheme_with_tone, args.phoneme_with_tone)
